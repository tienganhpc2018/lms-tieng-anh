...
DANH SÁCH HỌC SINH NHẬN ĐIỂM CỘNG KHEN THƯỞNG:`;
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-950/80 backdrop-blur-xs p-2 sm:p-4 overflow-y-auto print:p-0 print:bg-white">
      <div className="bg-white rounded-[2rem] w-full max-w-4xl border border-slate-200 shadow-2xl p-5 sm:p-7 space-y-4 my-auto max-h-[92vh] flex flex-col print:shadow-none print:border-none print:max-h-none print:p-2">
